    ...
    <div className='w-full h-screen text-center'>
        <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>
                ...
                <p className='py-4 text-gray-400 max-w-[70%] m-auto'>I'm a developer and a student focusing on Web3, Blockchain, Quantum, Creative Coding, Responsive Full-Stack, & Game Development.</p>
