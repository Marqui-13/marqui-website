...
const Contact = () => {
  ...
  return (
    <div id='contact' className='w-full lg:h-screen mt-40'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        <p className='text-xl tracking-widest uppercase text-[#15a8fd]'>
          Contact
        </p>
        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>Marqui Orr</h2>
                <p>Developer</p>
                <p className='py-4'>
          ...
          <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
            <div className='p-4'>
              ...
              >
                ...
                <button className='w-full p-4 text-gray-100 mt-4 bg-gradient-to-r from-[#15a8fd] via-blue-500 to-[#fff]-500'>
                  Send Message
                </button>
              </form>
            </div>
